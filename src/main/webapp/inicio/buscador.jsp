                ...
                <div class="flex flex-wrap items-center justify-around gap-5 mb-5">
                    ...
                    <div class="bg-[#8F9EB31C] lg:w-[18rem] w-full rounded-full flex gap-5 py-2 px-5">
                        ...
                        <div class="text-[#CBD5E1] w-full">
                            ...
                            <div class="relative mt-1">
                                <input type="text" id="ubicacion" class="bg-transparent text-[#8F9EB3] block w-full p-0 text-sm border-none focus:outline-none focus:right-0" value="El Alto, La Paz, Bolivia">
                                <div id="opcionesUbicacion" class="absolute w-full"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-[#8F9EB31C] lg:w-[18rem] w-full rounded-full flex gap-5 py-2 px-5">
                        ...
                        <div class="text-[#CBD5E1] w-full">
                            ...
                            <div class="relative mt-1">
                                <input type="text" id="date-range" class="bg-transparent text-[#8F9EB3] block w-full p-0 text-sm border-none focus:outline-none focus:right-0">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-[#8F9EB31C] lg:w-[18rem] w-full rounded-full flex gap-5 py-2 px-5">
                        ...
                        <div class="text-[#CBD5E1] w-full">
                            ...
                            <div class="relative mt-1">
                                <select id="huesped" class="bg-[#1D2432] text-[#8F9EB3] block w-full p-0 text-sm border-none focus:outline-none focus:right-0">
        ...
        <section class="p-5 lg:px-20 pt-5">
            <div class="flex flex-wrap items-center justify-around gap-5">
                ...
                <div class="w-[18rem] sm:w-full bg-[#8f9eb31c] rounded-md mb-5 sm:mx-36 sm:flex sm:p-5">          
                    ...
                    <img class="w-full sm:rounded-none sm:w-[10rem] h-[10rem] rounded-t-md object-cover" src="https://imgservice.alojamiento.io/500x245/hyatt-place-manati-pr-manati-bc-901390-0.jpg" alt="">
                    <div class="p-4 sm:px-4 sm:py-0 textPart lg:flex w-full justify-between ">
                        ...
                        <p class="text-gray-500 text-sm">
                            El Alto, La Paz, Bolivia, Ceja, Calle 2
                        </p>
                        ...
                        <div class="sm:flex sm:gap-3">
                            <div class="flex gap-2">
                                <img class="w-[1.3rem] h-[1.3rem]" src="https://cdn.pixabay.com/photo/2016/06/10/01/05/hotel-room-1447201_960_720.jpg" alt="">
                                <span class="text-[#8F9EB3]">Wi-Fi</span>
                            </div>
                            <div class="flex gap-2">
                                <img class="w-[1.3rem] h-[1.3rem]" src="https://cdn.pixabay.com/photo/2016/06/10/01/05/hotel-room-1447201_960_720.jpg" alt="">
                                <span class="text-[#8F9EB3]">2 camas individuales</span>
                            </div>
                        </div>
                        </div>  
                    </div>
                    ...
                    <div class="sm:w-[80%] sm:flex">
                        ...
                        <div class="p-4 sm:px-4 sm:py-0 textPart lg:flex w-full justify-between ">
                            <div class="space-y-1">
                                ...
                                <div class="text-[#95989F] text-sm sm:flex gap-2">
                                    <div class="flex gap-2">
                                        <strike>Bs. 150</strike>                  
                                        <span class="text-[#f4b848] text-sm font-bold"> Bs. 100</span><br>
                                    </div>
                                    <span class="inline-block rounded-full my-2 sm:my-0 py-1 sm:py-0 px-1 text-white bg-[#FE0000]">20% de descuento</span>
                                </div>
                                <div class="sm:flex sm:gap-3">
                                    <div class="flex gap-2">
                                        <img class="w-[1.3rem] h-[1.3rem]" src="https://cdn.pixabay.com/photo/2016/06/10/01/05/hotel-room-1447201_960_720.jpg" alt="">
