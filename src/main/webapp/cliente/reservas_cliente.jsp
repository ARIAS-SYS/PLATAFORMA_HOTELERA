                        ...
                        <div class="flex flex-wrap items-center justify-around gap-5">
                            ...
                            <div class="w-[18rem] sm:w-full bg-[#8f9eb31c] rounded-md mb-5 sm:mx-36 sm:flex sm:p-5">          
                                ...
                                <div class="sm:w-[80%] sm:flex">
                                    <img class="w-full sm:rounded-none sm:w-[12rem] h-[12rem] rounded-t-md object-cover" src="https://imgservice.alojamiento.io/500x245/hyatt-place-manati-pr-manati-bc-901390-0.jpg" alt="">
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <div class="sm:flex sm:gap-3 sm:flex-wrap text-sm">
                                                <div class="flex gap-2">
                                                    <img src="images/wifi.png" class="w-[1rem] h-[1rem]" alt="">
                                ...
                                <div class="sm:w-[20%] sm:flex sm:flex-col sm:justify-between mx-auto">
                                    ...
                                    <div>
                                        <span class="block w-fit mx-auto text-center rounded-full my-2 sm:my-0 py-1 sm:py-0 px-3 text-white bg-[#45dd5e]">
                                            Reservado
                                        </span>
                                    </div>
                                </div>         
                            ...
                            <div class="w-[18rem] sm:w-full bg-[#8f9eb31c] rounded-md mb-5 sm:mx-36 sm:flex sm:p-5">          
                                ...
                                <div class="sm:w-[20%] sm:flex sm:flex-col sm:justify-between mx-auto">
                                    ...
                                    <div>
                                        <span class="block w-fit mx-auto text-center rounded-full my-2 sm:my-0 py-1 sm:py-0 px-3 text-white bg-[#c640f7]">
                                            Completado
                                        </span>
                                    </div>
                                </div>         
